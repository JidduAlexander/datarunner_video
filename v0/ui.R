  ...
  dashboardBody(
    ...
    tabItems(
      tabItem(tabName = "home",
              p("VIDEO: quick steps, large jumps, fly (whitch video), Sprint, backwards, leisure, Hinkelen. 
                Questions: Does my running style have a speed limit. What's efficient running? What leads to fewer injuries?"),
              p("Login"), p("Create an account")
      ),
      ...
      tabItem(tabName = "video_analysis",
              # 2. THE RUN ------
              fluidRow(
                column(width = 2),
                column(
